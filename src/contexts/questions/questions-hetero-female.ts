...
export const questionsHeteroFemale: Question[] = [
  ...
  { 
    ...
    illustration: '/images/illustrations/techniques/Pegging him (exceed).png',
    forConfig: { 
      userGender: 'female',
      partnerGender: 'male',
      gameLevel: ['exceed'] 
  ...
  { 
    ...
    illustration: '/images/illustrations/techniques/Bukkake (exceed).png',
    forConfig: { 
      userGender: 'female',
      partnerGender: 'male',
      gameLevel: ['exceed'] 
  ...
  { 
    ...
    illustration: '/images/illustrations/techniques/Fisting (explore, exceed).png',
    forConfig: { 
      userGender: 'female',
      partnerGender: 'male',
      gameLevel: ['explore', 'exceed'] 
  ...
  { 
    ...
    illustration: '/images/illustrations/techniques/Trójkąt z kobietą (exceed).png',
    forConfig: { 
      userGender: 'female',
      partnerGender: 'male',
      gameLevel: ['exceed'] 
  ...
  { 
    ...
    illustration: '/images/illustrations/techniques/Trójkąt z mężczyzną (exceed).png',
    forConfig: { 
      userGender: 'female',
      partnerGender: 'male',
      gameLevel: ['exceed'] 
  ...
  { 
    ...
    illustration: '/images/illustrations/techniques/Orgia (exceed).png',
    forConfig: { 
      userGender: 'female',
      partnerGender: 'male',
      gameLevel: ['exceed'] 
  ...
  { 
    ...
    illustration: '/images/illustrations/techniques/Jej randka z nieznajomym (explore, exceed).png',
    forConfig: { 
      userGender: 'female',
      partnerGender: 'male',
      gameLevel: ['explore', 'exceed'] 
  ...
  { 
    ...
    illustration: '/images/illustrations/techniques/Sterowanie wibratorem w miejscu publicznym (explore, exceed).png',
    forConfig: { 
      userGender: 'female',
      partnerGender: 'male',
      gameLevel: ['explore', 'exceed'] 
